...
#dataset1 = print_distro(er_graph)

#data_jee = in_degree_distribution(er_graph)
#print data_jee

#print_distro(citation_graph)
#print_distro(er_graph)
DPA_graph = dpa_graph(27770, 13)
dataset1 = print_distro(DPA_graph)
...
simpleplot.plot_scatter(heading, 800, 600, x_label, y_label, [dataset1], ['DPA Graph'])
